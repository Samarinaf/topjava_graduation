...
public class UserTestData {
    public static final TestMatcher<User> USER_MATCHER = TestMatcher.usingIgnoringFieldsComparator("password");
    ...
    public static final User user = new User(USER_ID, "User", "user@yandex.ru", "{noop}userPassword", Role.USER);
    public static final User admin = new User(ADMIN_ID, "Admin", "admin@gmail.com", "{noop}adminPassword", Role.ADMIN);
