...
public class DishTestData {
    ...
    public static final Dish dish = new Dish(DISH_ID, "Coffee", 2.95, LocalDate.of(2021, 4, 12), RestaurantTestData.restaurant);
    ...
    public static final Dish dish_8 = new Dish(DISH_ID + 8, "Cheese Tomato & Red Onion Panini", 5.95, LocalDate.of(2021, 4, 12), RestaurantTestData.restaurant);
    public static final Dish dish_9 = new Dish(DISH_ID + 9, "Roast Ham & Pickle Sandwich", 5.45, LocalDate.of(2021, 4, 11), RestaurantTestData.restaurant_2);
